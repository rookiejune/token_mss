...
class MetaSampler:
    def __init__(
        ...
        segment_samples: int=512*256, # about 3 seconds for a 441 kHz audio
        remixing_sources: bool=False,
        mixaudio_dict: Dict=None,
        random_seed=1234,
    ):
        ...
        #         {'hdf5_path': 'songB.h5', 'key_in_hdf5': 'vocals', 'begin_sample': 44100},
        #         ... (e.g., 225752 dicts)
        #     ],
        #     'accompaniment': [
        #         {'hdf5_path': 'songA.h5', 'key_in_hdf5': 'vocals', 'begin_sample': 0}，
        ...
        while True:
            ...
            for source_type in self.source_types:
                ...
                while len(batch_meta_dict[source_type]) != batch_size:
                    if self.mixaudio_dict is not None and source_type in self.mixaudio_dict.keys():
    ...
    def state_dict(self) -> Dict:
        state = {
            'pointers_dict': self.pointers_dict,
            'indexes_dict': self.indexes_dict,
            'random_state_dict': self.random_state_dict
        }
        return state
    ...
    def load_state_dict(self, state):
        ...
        self.random_state_dict = state['random_state_dict']
